...
public class HomePageTest {
    ...
    @Test
    public void getHomePage_hasCorrectHomeLabel() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/").accept(MediaType.TEXT_HTML))
                .andExpect(status().isOk())
    ...
    @Test
    public void getHomePage_hasCorrectEarthquakeLink() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/").accept(MediaType.TEXT_HTML))
                .andExpect(status().isOk())
                .andExpect(xpath("//*[@id='navbarTogglerDemo03']/ul[1]/li[2]/a").exists())
				.andExpect(xpath("//*[@id='navbarTogglerDemo03']/ul[1]/li[2]/a").string("Earthquake"));
    }
}